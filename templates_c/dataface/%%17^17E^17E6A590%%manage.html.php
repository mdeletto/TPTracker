<?php /* Smarty version 2.6.18, created on 2017-02-28 13:29:50
         compiled from manage.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'use_macro', 'manage.html', 1, false),array('block', 'fill_slot', 'manage.html', 2, false),array('function', 'actions', 'manage.html', 6, false),array('modifier', 'escape', 'manage.html', 9, false),)), $this); ?>
...
?>
			<dt><a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['action']['url'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" <?php if ($this->_tpl_vars['action']['target']): ?>target="<?php echo ((is_array($_tmp=$this->_tpl_vars['action']['target'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['action']['label'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a></dt>
			<dd><?php echo ((is_array($_tmp=$this->_tpl_vars['action']['description'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</dd>
